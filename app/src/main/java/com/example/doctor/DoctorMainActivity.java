                                        ...
                                        if (count == 1 && efirst.isChecked()) {
                                            ...
                                            if(flash.isChecked())
                                            {
                                                if(count % 2 == 0)
                                                {
                                                    ...
                                                    bpm.setTextColor(Color.parseColor("#F6F7EB"));
                                                    beatdisplay.setTextColor(Color.parseColor("#393E41"));
                                                    offbeats.setTextColor(Color.parseColor("#F6F7EB"));
                                                    efirst.setTextColor(Color.parseColor("#F6F7EB"));
                                                    hidecounts.setTextColor(Color.parseColor("#F6F7EB"));
                                                    cats.setTextColor(Color.parseColor("#F6F7EB"));
                                                    firstOnly.setTextColor(Color.parseColor("#F6F7EB"));
                                                    flash.setTextColor(Color.parseColor("#F6F7EB"));
